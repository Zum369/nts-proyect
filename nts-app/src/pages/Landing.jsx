...
function Landing({ goToHome }) {
  ...
  const [state, handleSubmit] = useForm("mvolbkyv");
  ...
  return <>
    ...
    <Container>
      <h4 className='mt-title mb-title'>Quienes somos</h4>
      <Row xs={1} md={1} lg={3} className="g-2 pb-4">
        <Col>
    ...
    <Container className='className='mx-1 mt-3>
      <h4 className='mt-title mb-title'>Formulario de contacto</h4>
      <Row xs={1} md={2} >
        <Col data-aos="fade-right" className='mb-title'>
          <Form id='contact' onSubmit={handleSubmit} >
            ...
            <Form.Group className="mb-3">
              ...
              <Form.Control type="name" id="name" name="name" placeholder="Nombre" required />
              </Form.Group>
            <ValidationError
              prefix="Email"
              field="email"
            ...
            <Form.Group className="mb-3">
              ...
              <Form.Control as="textarea" id="message"
                name="message"
                placeholder="Mensaje" rows={11} required />
            </Form.Group>
            <Button type="submit" disabled={state.submitting}>Enviar</Button>
            {state.succeeded && <Toast className='mt-2'>
              <Toast.Body>Mensaje enviado, nos pondremos en contacto a la brevedad.</Toast.Body>
            </Toast>}
        ...
        <Col data-aos="fade-left" className='mb-title'>
          <Card className="border-white mx-1 mt-3 bg-dark text-white">
            <Card.Img src="https://picsum.photos/id/340/580/429/" alt="Card image" />
            <Card.ImgOverlay className='d-flex flex-column  align-items-start  text-white'>
              <Card.Title>Card title</Card.Title>
              <Card.Text>
                This is a wider card with supporting text below <br/>as a natural lead-in to
